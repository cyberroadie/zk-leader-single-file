 ...
 *
 */
package net.spike.zookeeper.retry;
...
/**
 * This file is copied from HBase code base:
 * http://svn.apache.org/viewvc/hbase/trunk/src/main/java/org/apache/hadoop/hbase/util/RetryCounter.java?view=markup
 * Changed the log implementation from apache to slf4j
 * User: cyberroadie
 * Date: 19/12/2011
 */
public class RetryCounter {
    ...
    public void sleepUntilNextRetry() throws InterruptedException {
        ...
        logger.info("The " + attempts + " times to retry after sleeping " + sleepTime
                + " ms");
